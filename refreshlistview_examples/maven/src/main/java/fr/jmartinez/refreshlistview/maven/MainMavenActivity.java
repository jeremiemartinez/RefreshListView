package fr.jmartinez.refreshlistview.maven;
...
public class MainMavenActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				Toast.makeText(MainMavenActivity.this, "Position: " + position, Toast.LENGTH_SHORT).show();
			}
	...
	private List<String> getApisList() {
		...
		apis.add("Android 2.2–2.2.3 Froyo (API level 8)");
		apis.add("Android 2.3–2.3.2 Gingerbread (API level 9)");
		apis.add("Android 2.3.3–2.3.7 Gingerbread (API level 10)");
		...
		apis.add("Android 4.0–4.0.2 Ice Cream Sandwich (API level 14)");
		apis.add("Android 4.0.3–4.0.4 Ice Cream Sandwich (API level 15)");
